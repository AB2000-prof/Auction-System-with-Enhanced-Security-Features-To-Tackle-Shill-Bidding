        ...
        <Carousel>
          ...
          <div className={classes.cardDetails}>
            <CardContent>
              ...
              {(product.status === "active" || product.status === "Time Ended") && <div>
              {product.status === "active" && <Link to="/sellerdashboard/editproduct"><Button variant="contained" color="primary">
  Edit Product   
</Button></Link>}
              <Button variant="contained" onClick={()=>setIsOpen(true)} className="ml-3" color="secondary">
  End Auction    
</Button>
</div>}
            </CardContent>
